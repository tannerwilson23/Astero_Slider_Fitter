...
pg = lc.to_periodogram(method='lombscargle', normalization='psd', minimum_frequency = 10, maximum_frequency=400)
#feel free to play around with smoothing here using the filter width
pg_smooth = pg.smooth(method='boxkernel', filter_width=10).power
